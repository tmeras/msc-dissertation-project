...
public class StudentInformationController {
    ...
    public ResponseEntity<StudentInformationDto> createStudentInformation(
        ...
        // The student whose information is being stored needs to be specified
        if (studentInformationEntity.getStudent() == null)
        ...
        System.out.println(savedStudentInformationEntity);
