...
export default function ClericalStaffEcDetails() {
    ...
    if (roleQuery.isError)
        ...
        return <ErrorPage 
                    ...
                    | Server Response: ${roleQuery.error.response?.data.status}-${roleQuery.error.response?.data.error}`} 
                /> 
    ...
    if (staffQuery.isError)
        ...
        return <ErrorPage 
                    ...
                    | Server Response: ${staffQuery.error.response?.data.status}-${staffQuery.error.response?.data.error}`} 
                /> 
